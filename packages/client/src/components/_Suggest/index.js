...
const Context = styled(enhance(({
  context, val, opened, className, showContext, id,
}) => (
...
const NgramContainer = styled(({
  className, query, strict, names, data,
}) => {
